...
class CustomTypes
{
  ...
  public function renderMetaBoxHTML($value) { ?>
    ...
    <div class="form-settings" ng-app ng-init='settings = <?= !empty($value) ? json_encode($value) : '{}'; ?>'>
      ...
      <div class="form-group">
        <input type="checkbox" name="<?= $this->metaKey; ?>[supports][]" ng-checked="settings.supports && settings.supports.indexOf('title') !== -1" value="title" /> Title<br>
        <input type="checkbox" name="<?= $this->metaKey; ?>[supports][]" ng-checked="settings.supports && settings.supports.indexOf('editor') !== -1" value="editor" /> Editor<br>
        <input type="checkbox" name="<?= $this->metaKey; ?>[supports][]" ng-checked="settings.supports && settings.supports.indexOf('comments') !== -1" value="comments" /> Comments<br>
        <input type="checkbox" name="<?= $this->metaKey; ?>[supports][]" ng-checked="settings.supports && settings.supports.indexOf('revisions') !== -1" value="revisions" /> Revisions<br>
